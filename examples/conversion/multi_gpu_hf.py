...
Usage:
torchrun --nproc_per_node 1 examples/conversion/multi_gpu_hf.py
torchrun --nproc_per_node 1 examples/conversion/multi_gpu_hf.py --megatron-save-path ./megatron_checkpoint
"""
