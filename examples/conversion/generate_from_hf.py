...
Example:
  ...
  python examples/conversion/generate_from_hf.py --hf_model_path="meta-llama/Llama-3.2-1B" --prompt="Hello, how are you?"

  # Load from Megatron checkpoint:
  python examples/conversion/generate_from_hf.py --hf_model_path="meta-llama/Llama-3.2-1B" --megatron_model_path="/path/to/megatron/checkpoint" --prompt="Hello, how are you?"
"""
