...
from megatron.bridge.recipes.qwen.qwen3_30b import pretrain_config
...
def main(args: argparse.Namespace) -> None:
    """
    Example launcher for Qwen3 30B MoE pretraining using nemo_run.Partial.
    """
    logger.info("Nemo Run Launcher for Qwen3 30B MoE using run.Partial")
    logger.info("======================================================")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Example launcher for Qwen3 30B MoE pretraining using nemo_run.Partial.")
    parser.add_argument(
