...
def main(
    ...
    if use_auto_detection:
        console.print(f"   Using auto-detected base model from adapter config...")
    ...
    console.print(f"   You can now load the converted adapters with:")
    console.print(f"   >>> from peft import AutoPeftModelForCausalLM")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--no-show-parameters", 
        action="store_true",
        help="Skip displaying parameter statistics"
    )
    parser.add_argument(
        "--no-auto-detect",
        action="store_true",
