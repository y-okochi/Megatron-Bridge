...
def main(
    ...
    if use_canonical:
        lora = CanonicalLoRA(target_modules=targets, dim=lora_rank, alpha=lora_alpha, dropout=lora_dropout)
    else:
        lora = LoRA(target_modules=targets, dim=lora_rank, alpha=lora_alpha, dropout=lora_dropout)
...
if __name__ == "__main__":
    ...
    main(
        args.base_model_id, args.lora_rank, args.lora_alpha, args.lora_dropout, args.use_canonical, args.target_modules
    )
