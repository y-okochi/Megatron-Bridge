...
from megatron.bridge.recipes.nemotronh.nemotronh_47b import model_config, pretrain_config
...
class TestPretrainConfig:
    ...
    @pytest.mark.parametrize("sequence_length", [1024, 2048, 4096, 8192, 16384, 32768, 65536])
