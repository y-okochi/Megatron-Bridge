...
from megatron.bridge.models.nemotronh import NemotronNano9Bv2Provider
from megatron.bridge.recipes.nemotronh.nemotron_nano_9b_v2 import model_config, pretrain_config
...
class TestPretrainConfig:
    ...
    @pytest.mark.parametrize("sequence_length", [1024, 2048, 4096, 8192, 16384, 32768])
