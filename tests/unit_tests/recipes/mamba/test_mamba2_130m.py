...
from megatron.bridge.models.mamba import MambaModelProvider130M
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, MambaModelProvider130M)
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, MambaModelProvider130M)
