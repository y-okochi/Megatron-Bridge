...
def llama3_8b_128k(**user_kwargs):
    recommended_kwargs = {
        "hf_path": "meta-llama/Meta-Llama-3-8B",
        "tensor_parallelism": 4,
        "pipeline_parallelism": 2,
