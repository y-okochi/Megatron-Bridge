...
from megatron.bridge.models.mistral import MistralSmall3ModelProvider24B
...
def model_config(
    ...
    """
    Configure the Mistral Small 3 24B model.
    ...
    Returns:
        MistralSmall3ModelProvider24B: Configuration for the Mistral 24B model.
    """
    model_cfg = MistralSmall3ModelProvider24B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Mistral Small 324B model. The default configuration is for 2 nodes with 8 GPUs per node.
