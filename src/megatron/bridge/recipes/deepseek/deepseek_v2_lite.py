...
from megatron.bridge.models.deepseek import DeepSeekV2LiteConfig
...
def model_config(
    ...
    Returns:
        DeepSeekV2LiteConfig: Configuration for the DeepSeek-V2-Lite model.
    """
    return DeepSeekV2LiteConfig(
