        ...
        **kwargs,
        ...
        if self.dist_aggregate_batch_interval:
            ...
            for mem_stat, val in memory_report.items():
                dist_memory_report[mem_stat + '_avg'] = _reduce_value(val, 'avg')
                dist_memory_report[mem_stat + '_min'] = _reduce_value(val, 'min')
                dist_memory_report[mem_stat + '_max'] = _reduce_value(val, 'max')
