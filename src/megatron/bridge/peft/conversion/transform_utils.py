...
class TransformFns:
    ...
    @staticmethod
    def split_qkv_lora_a(tensor: torch.Tensor, config: TransformerConfig) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    ...
    @staticmethod
    def split_qkv_lora_b(tensor: torch.Tensor, config: TransformerConfig) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
